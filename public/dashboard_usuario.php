        ...
        <div class="bg-white rounded-xl shadow-md p-6 transition-all hover:shadow-lg">
          <div class="flex justify-between items-start">
            <div>
              ...
              <h3 class="text-2xl font-bold text-gray-800 mt-1"><?= $peso ?> KG</h3>
              <p class="text-sm text-green-600 mt-1 flex items-center">
                <i class="fas fa-arrow-down text-green-600 w-4 h-4 mr-1"></i>
        ...
        <div class="bg-white rounded-xl shadow-md p-6 transition-all hover:shadow-lg">
          <div class="flex justify-between items-start">
            <div>
              ...
              <h3 class="text-2xl font-bold text-gray-800 mt-1"><?= $plano ?></h3>
              <p class="text-sm text-amber-600 mt-1 flex items-center">
                <i class="fas fa-clock text-amber-600 w-4 h-4 mr-1"></i>
                <?= $dia_renovacao ?>
              </p>
            </div>
        ...
        <div class="lg:col-span-2 space-y-6">
          ...
          <div class="bg-white rounded-xl shadow-md p-6">
            <div class="flex justify-between items-center mb-4">
              ...
              <span
                class="px-3 py-1 text-sm rounded-full bg-green-100 text-green-800">Treino A - Peito e Tríceps</span>
            </div>
            <div class="space-y-4">
              <div class="flex items-center p-3 bg-gray-50 rounded-lg">
                ...
                <div class="flex items-center">
                  <span class="text-sm font-medium text-gray-600 mr-2">30kg</span>
                  <input
                    type="checkbox"
              ...
              <div class="flex items-center p-3 bg-gray-50 rounded-lg">
                ...
                <div class="flex items-center">
                  <span class="text-sm font-medium text-gray-600 mr-2">15kg</span>
                  <input
                    type="checkbox"
                    class="form-checkbox h-5 w-5 text-indigo-600 rounded focus:ring-indigo-500" />
                </div>
              ...
              <div class="flex items-center p-3 bg-gray-50 rounded-lg">
                ...
                <div class="flex items-center">
                  <span class="text-sm font-medium text-gray-600 mr-2">25kg</span>
                  <input
                    type="checkbox"
                    class="form-checkbox h-5 w-5 text-indigo-600 rounded focus:ring-indigo-500" />
                </div>
              ...
              <div class="flex items-center p-3 bg-gray-50 rounded-lg">
                ...
                <div class="flex items-center">
                  <span class="text-sm font-medium text-gray-600 mr-2">12kg</span>
                  <input
                    type="checkbox"
                    class="form-checkbox h-5 w-5 text-indigo-600 rounded focus:ring-indigo-500" />
                </div>
            ...
            <div class="space-y-6">
              <div>
                <div class="flex justify-between mb-2">
                  <span class="text-sm font-medium text-gray-600">Perda de Peso</span>
              ...
              <div>
                <div class="flex justify-between mb-2">
                  <span class="text-sm font-medium text-gray-600">Frequência Semanal</span>
              ...
              <div>
                <div class="flex justify-between mb-2">
                  <span class="text-sm font-medium text-gray-600">Ganho Muscular</span>
            ...
            <div class="space-y-4">
              <div
                ...
                <div class="mr-4 text-center">
                  <span class="block text-lg font-bold text-indigo-600">18</span>
              ...
              <div class="flex items-center p-3 bg-gray-50 rounded-lg">
                <div class="mr-4 text-center">
                  <span class="block text-lg font-bold text-gray-600">20</span>
                  <span class="text-xs text-gray-500">JUN</span>
                </div>
                <div class="flex-1">
              ...
              <div class="flex items-center p-3 bg-gray-50 rounded-lg">
                <div class="mr-4 text-center">
                  <span class="block text-lg font-bold text-gray-600">22</span>
                  <span class="text-xs text-gray-500">JUN</span>
                </div>
                <div class="flex-1">
