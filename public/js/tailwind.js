...
;(() => {
  ...
  function t(t, o) {
          ...
          for (let n = o + 1; n < t.length; n++)
            if (((a = t.charCodeAt(n)), 92 === a)) n += 1
              ...
              if (
                ...
                throw new Error(
                  `Unterminated string: ${t.slice(r, n + 1) + String.fromCharCode(m)}`
                )
              if (a === e || (13 === a && t.charCodeAt(n + 1) === e))
                throw new Error(`Unterminated string: ${t.slice(r, n) + String.fromCharCode(m)}`)
            }
          f += t.slice(r, o + 1)
        } else {
          if (
            (32 === m || m === e || 9 === m) &&
            (a = t.charCodeAt(o + 1)) &&
            (32 === a || a === e || 9 === a || (13 === a && (a = t.charCodeAt(o + 2)) && a == e))
          )
            continue
          if (m === e) {
            if (0 === f.length) continue
            ;(a = f.charCodeAt(f.length - 1)), 32 !== a && a !== e && 9 !== a && (f += ' ')
            ...
            let c = n(f, s)
            if (!c) throw new Error('Invalid custom property, expected a value')
            ...
            if (((p = p.slice(0, -1)), f.length > 0))
              if (64 === f.charCodeAt(0))
                ...
                if (u) {
                  let t = n(f, e)
                  if (!t) throw new Error(`Invalid declaration: \`${f.trim()}\``)
                  i && ((t.src = [i, h, o]), (t.dst = [i, h, o])), u.nodes.push(t)
                }
              }
            let e = c.pop() ?? null
    ...
    if (p.length > 0 && u) {
      if ('rule' === u.kind) throw new Error(`Missing closing } at ${u.selector}`)
      if ('at-rule' === u.kind) throw new Error(`Missing closing } at ${u.name} ${u.params}`)
    }
      ...
      keysInNamespaces(e) {
        ...
        for (let r of e) {
          ...
          for (let n of this.values.keys())
            n.startsWith(e) && -1 === n.indexOf('--', 2) && (l(n, r) || t.push(n.slice(e.length)))
        }
        return t
      }
      get(e) {
    ...
    return (
      ...
      (e = (function (e) {
        ...
        N.some((t) => e.includes(t)) &&
          ((O.lastIndex = 0), (e = e.replace(O, (e, r) => ((t = !0), `$${N.indexOf(r)}$(`))))
        let r = '',
          n = []
  ...
  function q(e) {
    ...
    let t = Q(e.value),
      ...
      [n, o] = t ? ['(', ')'] : ['[', ']']
    return 'arbitrary' === e.kind ? `/${n}${Y(r)}${o}` : 'named' === e.kind ? `/${e.value}` : ''
  }
  function H(e) {
  ...
  var ke = new RegExp(`^${de.source}(${['deg', 'rad', 'grad', 'turn'].join('|')})$`)
    ...
    return I(e, ',')
      .map((e) => {
        ...
        for (let e of r)
          Ce.has(e) ||
            (je.test(e)
              ? (null === o ? (o = e) : null === i && (i = e), (je.lastIndex = 0))
              : null === n && (n = e))
  ...
  function Be(e, t, r, n, o = '') {
    let i = !1,
      a = Te(t, (e) =>
        null == r
          ...
          ? n(Oe(e, r))
          : ((e.startsWith('var(') || r.startsWith('var(')) && (i = !0), n(Fe(e, r)))
      )
    function l(e) {
      return o
        ? I(e, ',')
    ...
    return i
      ? [y(e, l(Te(t, n))), b('@supports (color: lab(from red l a b))', [y(e, l(a))])]
      : [y(e, l(a))]
  }
  ...
  function tt(e) {
    let t = (function (e) {
        ...
        function r(r, n) {
          function* o(t) {
            for (let r of e.keysInNamespaces(t)) yield r.replace(De, (e, t, r) => `${t}.${r}`)
          }
          let i = [
            '1/2',
            '1/3',
        ...
        t.static('container', () => {
          ...
          t.functional('flex', (e) => {
            if (e.value) {
              ...
              if (e.value.fraction) {
                ...
                return ye(t) && ye(r) ? [y('flex', `calc(${e.value.fraction} * 100%)`)] : void 0
              }
              if (ye(e.value.value)) return e.modifier ? void 0 : [y('flex', e.value.value)]
            }
          }),
          ...
          a('basis', ['--flex-basis', '--spacing', '--container'], (e) => [y('flex-basis', e)], {
            supportsFractions: !0,
          }),
        ...
        a('border-spacing', ['--border-spacing', '--spacing'], (e) => [
          ...
          y('border-spacing', 'var(--tw-border-spacing-x) var(--tw-border-spacing-y)'),
        ]),
        ...
        let s = () =>
          z([Ne('--tw-translate-x', '0'), Ne('--tw-translate-y', '0'), Ne('--tw-translate-z', '0')])
        ...
        a(
          ...
          (e) => [
            s(),
            y('--tw-translate-z', e),
            y('translate', 'var(--tw-translate-x) var(--tw-translate-y) var(--tw-translate-z)'),
          ],
          { supportsNegative: !0 }
        ),
          n('translate-3d', [
        ...
        let c = () => z([Ne('--tw-scale-x', '1'), Ne('--tw-scale-y', '1'), Ne('--tw-scale-z', '1')])
        function u({ negative: t }) {
          return (r) => {
            if (!r.value || r.modifier) return
            let n
            return 'arbitrary' === r.value.kind
              ? ((n = r.value.value), (n = t ? `calc(${n} * -1)` : n), [y('scale', n)])
        ...
        function d({ negative: t }) {
          return (r) => {
            ...
            if ('arbitrary' === r.value.kind) {
              ...
              if ('angle' !== e) return [y('rotate', t ? `calc(${n} * -1)` : n)]
            } else if (
        ...
        let f = () => z([Ne('--tw-pan-x'), Ne('--tw-pan-y'), Ne('--tw-pinch-zoom')])
        ...
        n('grid-flow-row', [['grid-auto-flow', 'row']]),
          ...
          o('grid-cols', {
            ...
            handleBareValue: ({ value: e }) => (xe(e) ? `repeat(${e}, minmax(0, 1fr))` : null),
          ...
          a(
            ...
            (e) => [
              ...
              w(':where(& > :not(:last-child))', [
                ...
                y('margin-inline-start', `calc(${e} * var(--tw-space-x-reverse))`),
                y('margin-inline-end', `calc(${e} * calc(1 - var(--tw-space-x-reverse)))`),
              ]),
            ],
            { supportsNegative: !0 }
          ),
          a(
            ...
            (e) => [
              ...
              w(':where(& > :not(:last-child))', [
                ...
                y('margin-block-start', `calc(${e} * var(--tw-space-y-reverse))`),
                y('margin-block-end', `calc(${e} * calc(1 - var(--tw-space-y-reverse)))`),
              ]),
            ],
            { supportsNegative: !0 }
          ),
          ...
          ])
        {
          let i = function (n, o) {
              t.functional(n, (t) => {
                ...
                if ('arbitrary' === t.value.kind) {
                  let r = t.value.value
                  switch (t.value.dataType ?? ae(r, ['color', 'line-width', 'length'])) {
                    case 'line-width':
                    case 'length': {
                      if (t.modifier) return
                      let e = o.width(r)
                    ...
                    default:
                      return (r = We(r, t.modifier, e)), null === r ? void 0 : o.color(r)
                  }
                }
                {
          ...
          i('border', {
            ...
            o('divide-x', {
              ...
              handle: (e) => [
                ...
                w(':where(& > :not(:last-child))', [
                  ...
                  y('border-inline-style', 'var(--tw-border-style)'),
                  y('border-inline-start-width', `calc(${e} * var(--tw-divide-x-reverse))`),
                  y('border-inline-end-width', `calc(${e} * calc(1 - var(--tw-divide-x-reverse)))`),
                ]),
              ],
            }),
            o('divide-y', {
              ...
              handle: (e) => [
                ...
                w(':where(& > :not(:last-child))', [
                  ...
                  y('border-bottom-style', 'var(--tw-border-style)'),
                  y('border-top-style', 'var(--tw-border-style)'),
                  y('border-top-width', `calc(${e} * var(--tw-divide-y-reverse))`),
                  y('border-bottom-width', `calc(${e} * calc(1 - var(--tw-divide-y-reverse)))`),
                ]),
              ],
            }),
            r('divide-x', () => [
            ...
            n('divide-x-reverse', [
              () => z([Ne('--tw-divide-x-reverse', '0')]),
              () => w(':where(& > :not(:last-child))', [y('--tw-divide-x-reverse', '1')]),
            ]),
            n('divide-y-reverse', [
              () => z([Ne('--tw-divide-y-reverse', '0')]),
              () => w(':where(& > :not(:last-child))', [y('--tw-divide-y-reverse', '1')]),
            ])
                  ...
                  return 'angle' === (r.value.dataType ?? ae(e, ['angle']))
                    ? ((e = t ? `calc(${e} * -1)` : `${e}`),
                      [
                        ...
                        y('background-image', `linear-gradient(var(--tw-gradient-stops,${e}))`),
                      ])
                    : t
                    ? void 0
                    : [
            ...
            o = function ({ negative: t }) {
              return (r) => {
                if ('arbitrary' === r.value?.kind) {
                  ...
                  return [
                    y('--tw-gradient-position', e),
                    y('background-image', `conic-gradient(var(--tw-gradient-stops,${e}))`),
                  ]
                }
                let n = e(r.modifier)
                if (!r.value)
                  return [
                    y('--tw-gradient-position', n),
                    y('background-image', 'conic-gradient(var(--tw-gradient-stops))'),
                  ]
                let o = r.value.value
                return ye(o)
            ...
            t.functional('bg-radial', (t) => {
              if (!t.value)
                return [
                  ...
                  y('background-image', 'radial-gradient(var(--tw-gradient-stops))'),
                ]
              if ('arbitrary' === t.value.kind) {
                if (t.modifier) return
                let e = t.value.value
                return [
                  y('--tw-gradient-position', e),
                  y('background-image', `radial-gradient(var(--tw-gradient-stops,${e}))`),
                ]
              }
            }),
        ...
        t.functional('bg', (t) => {
          if (t.value) {
            if ('arbitrary' === t.value.kind) {
              ...
              switch (
                t.value.dataType ??
                ae(r, ['image', 'color', 'percentage', 'position', 'bg-size', 'length', 'url'])
              ) {
                case 'percentage':
                case 'position':
                ...
                default:
                  return (
                    (r = We(r, t.modifier, e)), null === r ? void 0 : [y('background-color', r)]
                  )
              }
            }
            {
        ...
        function m(n, o) {
          t.functional(n, (t) => {
            if (t.value) {
              if ('arbitrary' === t.value.kind) {
                let r = t.value.value
                switch (t.value.dataType ?? ae(r, ['color', 'length', 'percentage'])) {
                  case 'length':
                  case 'percentage':
        ...
        m('from', {
          ...
          t.functional('mask', (e) => {
            ...
            switch (
              e.value.dataType ??
              ae(t, ['image', 'percentage', 'position', 'bg-size', 'length', 'url'])
            ) {
              case 'percentage':
              case 'position':
        ...
        function v(n, o) {
          t.functional(n, (t) => {
            if (t.value) {
              if ('arbitrary' === t.value.kind) {
                let r = t.value.value
                switch (t.value.dataType ?? ae(r, ['length', 'percentage', 'color'])) {
                  case 'color':
                    return (r = We(r, t.modifier, e)), null === r ? void 0 : o.color(r)
                  case 'percentage':
                    return t.modifier || !ye(r.slice(0, -1)) ? void 0 : o.position(r)
                  default:
                    return t.modifier ? void 0 : o.position(r)
                }
              }
              ...
              }
              {
                ...
                switch (r) {
                  ...
                  case 'percentage':
                    return ye(t.value.value.slice(0, -1)) ? o.position(t.value.value) : void 0
                  default:
                    return
                }
              }
        ...
        o('mask-linear', {
          ...
          supportsNegative: !0,
          supportsFractions: !1,
          handleBareValue: (e) => (ye(e.value) ? `calc(1deg * ${e.value})` : null),
          handleNegativeBareValue: (e) => (ye(e.value) ? `calc(1deg * -${e.value})` : null),
          handle: (e) => [
            g(),
            A(),
            y('mask-image', 'var(--tw-mask-linear), var(--tw-mask-radial), var(--tw-mask-conic)'),
            y('mask-composite', 'intersect'),
            y(
              '--tw-mask-linear',
          ...
          v('mask-linear-from', {
            color: (e) => [
              ...
              y('--tw-mask-linear', 'linear-gradient(var(--tw-mask-linear-stops))'),
        ...
        n('mask-circle', [['--tw-mask-radial-shape', 'circle']]),
          ...
          v('mask-radial-from', {
            color: (e) => [
              ...
              y('--tw-mask-radial', 'radial-gradient(var(--tw-mask-radial-stops))'),
        ...
        o('mask-conic', {
          ...
          v('mask-conic-from', {
            color: (e) => [
              ...
              y('--tw-mask-conic', 'conic-gradient(var(--tw-mask-conic-stops))'),
        ...
        n('mix-blend-plus-darker', [['mix-blend-mode', 'plus-darker']]),
          ...
          t.functional('stroke', (t) => {
            if (t.value) {
              if ('arbitrary' === t.value.kind) {
                let r = t.value.value
                switch (t.value.dataType ?? ae(r, ['color', 'number', 'length', 'percentage'])) {
                  case 'number':
                  case 'length':
                  case 'percentage':
                  ...
                  default:
                    return (
                      (r = We(t.value.value, t.modifier, e)), null === r ? void 0 : [y('stroke', r)]
                    )
                }
              }
              {
              ...
              }
              {
                ...
                if (ye(t.value.value)) return [y('stroke-width', t.value.value)]
              }
            }
          }),
          r('stroke', () => [
        ...
        n('text-left', [['text-align', 'left']]),
          ...
          a('indent', ['--text-indent', '--spacing'], (e) => [y('text-indent', e)], {
            supportsNegative: !0,
          }),
          ...
          t.functional('font', (t) => {
            if (t.value && !t.modifier) {
              if ('arbitrary' === t.value.kind) {
                let e = t.value.value
                switch (t.value.dataType ?? ae(e, ['number', 'generic-name', 'family-name'])) {
                  case 'generic-name':
                  case 'family-name':
              ...
              }
              {
                ...
                if (r) {
                  ...
                  return [
                    ...
                    y('font-variation-settings', t['--font-variation-settings']),
                  ]
                }
              }
              {
          ...
          i('placeholder', {
            ...
            handle: (e) => [
              w('&::placeholder', [y('--tw-sort', 'placeholder-color'), y('color', e)]),
            ],
          }),
          ...
          })
        {
          ...
          t.functional('filter', (e) => {
            ...
            t.functional('backdrop-filter', (e) => {
              if (!e.modifier) {
                if (null === e.value)
                  return [s(), y('-webkit-backdrop-filter', a), y('backdrop-filter', a)]
                if ('arbitrary' === e.value.kind)
                  return [
                ...
                if ('none' === e.value.value)
                  return [y('-webkit-backdrop-filter', 'none'), y('backdrop-filter', 'none')]
              }
            }),
            o('blur', {
              themeKeys: ['--blur'],
              handle: (e) => [l(), y('--tw-blur', `blur(${e})`), y('filter', i)],
            }),
            ...
            o('brightness', {
              ...
              handleBareValue: ({ value: e }) => (ye(e) ? `${e}%` : null),
              handle: (e) => [l(), y('--tw-brightness', `brightness(${e})`), y('filter', i)],
            }),
            ...
            o('contrast', {
              themeKeys: ['--contrast'],
              handleBareValue: ({ value: e }) => (ye(e) ? `${e}%` : null),
              handle: (e) => [l(), y('--tw-contrast', `contrast(${e})`), y('filter', i)],
            }),
            o('backdrop-contrast', {
            ...
            o('grayscale', {
              ...
              handleBareValue: ({ value: e }) => (ye(e) ? `${e}%` : null),
              defaultValue: '100%',
              handle: (e) => [l(), y('--tw-grayscale', `grayscale(${e})`), y('filter', i)],
            }),
            ...
            o('hue-rotate', {
              ...
              handleBareValue: ({ value: e }) => (ye(e) ? `${e}deg` : null),
              handle: (e) => [l(), y('--tw-hue-rotate', `hue-rotate(${e})`), y('filter', i)],
            }),
            ...
            o('invert', {
              ...
              handleBareValue: ({ value: e }) => (ye(e) ? `${e}%` : null),
              defaultValue: '100%',
              handle: (e) => [l(), y('--tw-invert', `invert(${e})`), y('filter', i)],
            }),
            o('backdrop-invert', {
            ...
            o('saturate', {
              themeKeys: ['--saturate'],
              handleBareValue: ({ value: e }) => (ye(e) ? `${e}%` : null),
              handle: (e) => [l(), y('--tw-saturate', `saturate(${e})`), y('filter', i)],
            }),
            o('backdrop-saturate', {
            ...
            o('sepia', {
              ...
              handleBareValue: ({ value: e }) => (ye(e) ? `${e}%` : null),
              defaultValue: '100%',
              handle: (e) => [l(), y('--tw-sepia', `sepia(${e})`), y('filter', i)],
            }),
            o('backdrop-sepia', {
                ...
                return 'color' === (t.value.dataType ?? ae(n, ['color']))
                  ? ((n = We(n, t.modifier, e)),
                    null === n
                      ...
                      : [
                          l(),
                          y('--tw-drop-shadow-color', Oe(n, 'var(--tw-drop-shadow-alpha)')),
              ...
              }
              {
                ...
                if (r)
                  return 'inherit' === r
                    ...
                    : [
                        l(),
                        y('--tw-drop-shadow-color', Oe(r, 'var(--tw-drop-shadow-alpha)')),
                        y('--tw-drop-shadow', 'var(--tw-drop-shadow-size)'),
                      ]
              }
            }),
                ...
                return (
                  'arbitrary' === t.value.kind
                    ...
                    : ((n = e.resolve(t.value.fraction ?? t.value.value, [
                      ...
                      null === n && ye(t.value.value) && (n = `${t.value.value}ms`)),
                  null !== n ? [r(), y('--tw-duration', n), y('transition-duration', n)] : void 0
                )
              })
          }
          r('delay', () => [
        ...
        }
        {
          ...
          t.static('outline-hidden', () => [
            ...
            t.functional('outline', (t) => {
              ...
              if ('arbitrary' === t.value.kind) {
                let r = t.value.value
                switch (t.value.dataType ?? ae(r, ['color', 'length', 'number', 'percentage'])) {
                  case 'length':
                  case 'number':
                  case 'percentage':
                    return t.modifier
                      ? void 0
                      : [i(), y('outline-style', 'var(--tw-outline-style)'), y('outline-width', r)]
                  default:
                    return (r = We(r, t.modifier, e)), null === r ? void 0 : [y('outline-color', r)]
                }
              }
              {
          ...
          t.functional('text', (t) => {
            if (t.value) {
              if ('arbitrary' === t.value.kind) {
                ...
                switch (
                  t.value.dataType ??
                  ae(r, ['color', 'length', 'percentage', 'absolute-size', 'relative-size'])
                ) {
                  case 'size':
                  case 'length':
                  case 'percentage':
                  ...
                  default:
                    return (r = We(r, t.modifier, e)), null === r ? void 0 : [y('color', r)]
                }
              }
              {
        ...
        let T = () =>
          z([Ne('--tw-text-shadow-color'), Ne('--tw-text-shadow-alpha', '100%', '<percentage>')])
        n('text-shadow-initial', [T, ['--tw-text-shadow-color', 'initial']]),
          t.functional('text-shadow', (t) => {
            ...
            if (
              ...
              return null === t
                ...
                : [
                    ...
                    ...Be('text-shadow', t, r, (e) => `var(--tw-text-shadow-color, ${e})`),
                  ]
            }
            if ('arbitrary' === t.value.kind) {
              let n = t.value.value
              return 'color' === (t.value.dataType ?? ae(n, ['color']))
                ? ((n = We(n, t.modifier, e)),
                  null === n
                    ? void 0
                    : [T(), y('--tw-text-shadow-color', Oe(n, 'var(--tw-text-shadow-alpha)'))])
                : [
                    T(),
                    y('--tw-text-shadow-alpha', r),
                    ...Be('text-shadow', n, r, (e) => `var(--tw-text-shadow-color, ${e})`),
                  ]
            }
            switch (t.value.value) {
              ...
              case 'inherit':
                return t.modifier ? void 0 : [T(), y('--tw-text-shadow-color', 'inherit')]
            }
            {
            ...
            }
            {
              ...
              if (r) return [T(), y('--tw-text-shadow-color', Oe(r, 'var(--tw-text-shadow-alpha)'))]
            }
          }),
          r('text-shadow', () => [
            {
          ...
          ])
        {
          ...
          n('shadow-initial', [s, ['--tw-shadow-color', 'initial']]),
            t.functional('shadow', (t) => {
              ...
              if (
                ...
                return null === t
                  ...
                  : [
                      s(),
                      y('--tw-shadow-alpha', r),
                      ...Be('--tw-shadow', t, r, (e) => `var(--tw-shadow-color, ${e})`),
                      y('box-shadow', a),
                    ]
              }
              if ('arbitrary' === t.value.kind) {
                ...
                return 'color' === (t.value.dataType ?? ae(n, ['color']))
                  ? ((n = We(n, t.modifier, e)),
                    null === n
                      ? void 0
                      : [s(), y('--tw-shadow-color', Oe(n, 'var(--tw-shadow-alpha)'))])
                  : [
                      s(),
                      y('--tw-shadow-alpha', r),
                      ...Be('--tw-shadow', n, r, (e) => `var(--tw-shadow-color, ${e})`),
                      y('box-shadow', a),
                    ]
              }
              switch (t.value.value) {
                case 'none':
                  return t.modifier ? void 0 : [s(), y('--tw-shadow', l), y('box-shadow', a)]
                case 'inherit':
                  return t.modifier ? void 0 : [s(), y('--tw-shadow-color', 'inherit')]
              }
              {
              ...
              }
              {
                ...
                if (r) return [s(), y('--tw-shadow-color', Oe(r, 'var(--tw-shadow-alpha)'))]
              }
            }),
            r('shadow', () => [
              {
            ...
            t.functional('inset-shadow', (t) => {
              ...
              if (
                ...
                return null === t
                  ...
                  : [
                      ...
                      ...Be('--tw-inset-shadow', t, r, (e) => `var(--tw-inset-shadow-color, ${e})`),
                      y('box-shadow', a),
                    ]
              }
              if ('arbitrary' === t.value.kind) {
                ...
                return 'color' === (t.value.dataType ?? ae(n, ['color']))
                  ? ((n = We(n, t.modifier, e)),
                    null === n
                      ? void 0
                      : [s(), y('--tw-inset-shadow-color', Oe(n, 'var(--tw-inset-shadow-alpha)'))])
                  : [
                      s(),
                      y('--tw-inset-shadow-alpha', r),
                      ...Be(
              ...
              switch (t.value.value) {
                case 'none':
                  return t.modifier ? void 0 : [s(), y('--tw-inset-shadow', l), y('box-shadow', a)]
                case 'inherit':
                  return t.modifier ? void 0 : [s(), y('--tw-inset-shadow-color', 'inherit')]
              }
              {
                ...
                if (n)
                  return [
                    s(),
                    y('--tw-inset-shadow-alpha', r),
                    ...Be('--tw-inset-shadow', n, r, (e) => `var(--tw-inset-shadow-color, ${e})`),
                    y('box-shadow', a),
                  ]
              }
              {
                let r = Ue(t, e, ['--box-shadow-color', '--color'])
                if (r)
                  return [s(), y('--tw-inset-shadow-color', Oe(r, 'var(--tw-inset-shadow-alpha)'))]
              }
            }),
            r('inset-shadow', () => [
              {
          ...
          t.functional('ring', (t) => {
            ...
            if ('arbitrary' === t.value.kind) {
              let r = t.value.value
              return 'length' === (t.value.dataType ?? ae(r, ['color', 'length']))
                ? t.modifier
                  ? void 0
                  : [s(), y('--tw-ring-shadow', o(r)), y('box-shadow', a)]
                : ((r = We(r, t.modifier, e)), null === r ? void 0 : [y('--tw-ring-color', r)])
            }
            {
            ...
            }
            {
              ...
              if ((null === r && ye(t.value.value) && (r = `${t.value.value}px`), r))
                return [s(), y('--tw-ring-shadow', o(r)), y('box-shadow', a)]
            }
          }),
            r('ring', () => [
            ...
            t.functional('inset-ring', (t) => {
              if (!t.value)
                return t.modifier
                  ? void 0
                  : [s(), y('--tw-inset-ring-shadow', i('1px')), y('box-shadow', a)]
              if ('arbitrary' === t.value.kind) {
                let r = t.value.value
                return 'length' === (t.value.dataType ?? ae(r, ['color', 'length']))
                  ? t.modifier
                    ? void 0
                    : [s(), y('--tw-inset-ring-shadow', i(r)), y('box-shadow', a)]
                  : ((r = We(r, t.modifier, e)),
              ...
              }
              {
                ...
                let r = e.resolve(t.value.value, ['--ring-width'])
                if ((null === r && ye(t.value.value) && (r = `${t.value.value}px`), r))
                  return [s(), y('--tw-inset-ring-shadow', i(r)), y('box-shadow', a)]
              }
            }),
            r('inset-ring', () => [
              {
            ...
            if (t.value) {
              if ('arbitrary' === t.value.kind) {
                ...
                return 'length' === (t.value.dataType ?? ae(r, ['color', 'length']))
                  ? t.modifier
                    ? void 0
                    : [y('--tw-ring-offset-width', r), y('--tw-ring-offset-shadow', u)]
                  : ((r = We(r, t.modifier, e)),
        ...
        return (
          ...
          t.functional('@container', (e) => {
            ...
            if (
              ...
              return e.modifier
                ? [y('container-type', t), y('container-name', e.modifier.value)]
                : [y('container-type', t)]
          }),
      ...
      r = (function (e) {
          ...
          t.compound('group', 2, (t, r) => {
            ...
            return (
              A([t], (e, { path: t }) => {
                ...
                I(r, ',').length > 1 && (r = `:is(${r})`), (e.selector = `&:is(${r} *)`), (o = !0)
              }),
              o ? void 0 : null
            )
          }),
        ...
        r('first', ['&:first-child']),
          ...
          t.functional('nth', (e, t) => {
            if (!t.value || t.modifier || ('named' === t.value.kind && !ye(t.value.value)))
              return null
      ...
      a = new c((e) => {
        let t = (function (e, t) {
          ...
          for (let o of r) {
            ...
            for (let r of e.variants) if (null === ot(a, r, t.variants)) return []
  ...
  function ot(e, t, r, n = 0) {
    if ('arbitrary' === t.kind)
      return t.relative && 0 === n ? null : void (e.nodes = [b(t.selector, e.nodes)])
    let { applyFn: o } = r.get(t.root)
    if ('compound' === t.kind) {
      let i = k('@slot')
      if (null === ot(i, t.variant, r, n + 1) || ('not' === t.root && i.nodes.length > 1))
        return null
    ...
    A([n], (e, { parent: n, path: l }) => {
      if ('at-rule' === e.kind) {
        ...
        if ('@apply' === e.name) {
          if (null === n) return
          ;(r |= 1), o.add(n)
          for (let r of ct(e, t)) for (let t of l) t !== e && o.has(t) && i.get(t).add(r)
        }
      }
    })
    let l = new Set(),
  ...
  function mt(e, t = [], r) {
    for (let n of Reflect.ownKeys(e)) {
      ...
      if (1 !== a) {
        if (2 === a) return 2
        if ((Array.isArray(o) || 'object' == typeof o) && 2 === mt(o, i, r)) return 2
      }
    }
  }
  function gt(e) {
    ...
    return function (n, o) {
      ...
      let s = (() => {
        ...
        if (null !== s && 'object' == typeof s && !Array.isArray(s)) {
          ...
          for (let t in a)
            '__CSS_VALUES__' !== t &&
              ((4 & s?.__CSS_VALUES__?.[t] && void 0 !== bt(e, t.split('-'))) || (e[i(t)] = a[t]))
          return e
        }
  ...
  function jt(e, t, r = null) {
    for (let n = 0; n < e.length; n++) {
      ...
      if (i) 0 === l ? n-- : (n += a - 1)
        ...
        if (2 === l) return 2
        if (1 !== l && 'function' === o.kind && 2 === jt(o.nodes, t, o)) return 2
      }
    }
  }
  function Tt(e) {
      ...
      switch (l) {
        ...
        case 40: {
          ...
          if (
            ...
            let c = a
            l.nodes.push(Ct(e.slice(n, c))), (i = ''), (a = c), o ? o.nodes.push(l) : r.push(l)
            break
          }
  ...
  function Et({ designSystem: e, ast: t, resolvedConfig: r, featuresRef: n, referenceMode: o }) {
    let i = {
      addBase(r) {
        if (o) return
        let i = Vt(r)
  ...
  function Vt(e) {
    ...
    for (let [e, n] of r)
      if ('object' != typeof n) {
        ...
        for (let r of n) 'string' == typeof r ? t.push(y(e, r)) : t.push(b(e, Vt(r)))
  ...
  function Ft(e, t, r) {
    for (let r of (function (e) {
      ...
      if ('keyframes' in e.theme)
        for (let [r, n] of Object.entries(e.theme.keyframes)) t.push(k('@keyframes', r, Vt(n)))
      return t
    })(t))
  ...
  function Gt(e, { config: t, base: r, path: n, reference: o }) {
    ...
    for (let i of t.presets ?? []) Gt(e, { path: n, base: r, config: i, reference: o })
    for (let t of i)
      e.plugins.push(t),
        t.config &&
          Gt(e, {
  ...
  async function tr({ designSystem: e, base: t, ast: r, loadModule: n, sources: o }) {
    ...
    A(r, (e, { parent: t, replaceWith: r, context: n }) => {
      ...
      (function (e) {
        ...
        e.utilities.static('bg-left-top', () => [y('background-position', 'left top')]),
          e.utilities.static('bg-right-top', () => [y('background-position', 'right top')]),
          e.utilities.static('bg-left-bottom', () => [y('background-position', 'left bottom')]),
          e.utilities.static('bg-right-bottom', () => [y('background-position', 'right bottom')]),
          e.utilities.static('object-left-top', () => [y('object-position', 'left top')]),
          e.utilities.static('object-right-top', () => [y('object-position', 'right top')]),
          e.utilities.static('object-left-bottom', () => [y('object-position', 'left bottom')]),
          e.utilities.static('object-right-bottom', () => [y('object-position', 'right bottom')]),
          ...
          e.utilities.static('overflow-ellipsis', () => [y('text-overflow', 'ellipsis')]),
  ...
  function rr({ designSystem: e, base: t, ast: r, sources: n, configs: o, pluginDetails: i }) {
    let a = 0,
      l = [
        ...i.map((e) => {
          if (!e.options)
  ...
  async function cr(e, { base: t = '', from: r, loadModule: n = lr, loadStylesheet: a = sr } = {}) {
    let l = 0
            ...
            if (r.startsWith('source(')) {
              ...
              A(e.nodes, (e, { replaceWith: r }) => {
                if ('at-rule' === e.kind && '@tailwind' === e.name && 'utilities' === e.params)
                  return (e.params += ` source(${t})`), r([$({ sourceBase: n.base }, [e])]), 2
              })
    ...
    let E = tt(u)
    if ((c && (E.important = c), S.length > 0)) for (let e of S) E.invalidCandidates.add(e)
    l |= await tr({
      designSystem: E,
      base: t,
      ast: e,
  ...
  async function ur(e, r = {}) {
    let n = t(e, { from: r.from }),
      o = await (async function (e, t = {}) {
        ...
        n.unshift(x('! tailwindcss v4.1.8 | MIT License | https://tailwindcss.com '))
        let u = new Set(),
          d = null,
          f = 0,
          p = !1
