...
function listarTabelasMySQL() {
    ...
    // Retornar o array com os nomes das tabelas
    return $tabelas;
}


$tabelas = listarTabelasMySQL();

// Exibir as tabelas
echo "Tabelas no banco 'gym_genesis':\n";
...
<body>
    ...
    <select id="selectTabelas">
        ...
        <option value="perfil_professor">perfil_professor</option>
