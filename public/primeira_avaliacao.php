...
<body class="bg-gray-900 text-white min-h-screen flex items-center justify-center">
    <form id="formulario" method="POST" action="salvar_primeira_avaliacao.php" class="w-full max-w-xl bg-gray-800 rounded-2xl p-8 space-y-8 shadow-xl">

        <!-- Etapa 1: Saudação -->
        <!-- Etapa 1: Boas-vindas com animação -->
<div class="etapa text-center animate-fade-in-up">
  <h1 class="text-3xl font-bold mb-4">👋 Olá, Pablo!</h1>
...
.animate-fade-in-up {
  animation: fade-in-up 0.6s ease-out both;
        ...
        <div class="etapa hidden text-center">
            ...
            <button type="submit" class="bg-green-500 hover:bg-green-600 px-8 py-3 rounded-full font-semibold">Ir para meu Dashboard</button>
        </div>
