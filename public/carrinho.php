...
// Simulação (remova quando tiver banco)
if (empty($carrinho)) {
    $carrinho = [
        ["id" => 1, "nome" => "Whey Protein", "preco" => 120.00, "qtd" => 1, "icone" => "fa-dumbbell"],
        ["id" => 2, "nome" => "Camisa Dry Fit", "preco" => 79.90, "qtd" => 2, "icone" => "fa-shirt"],
        ["id" => 3, "nome" => "Creatina", "preco" => 95.50, "qtd" => 1, "icone" => "fa-bolt"]
    ];
}
...
// Subtotal bruto (para JS) e formatado (para exibição)
$subtotal = totalCarrinho($carrinho);
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="lg:col-span-2 space-y-6">
                    <?php foreach ($carrinho as $item): ?>
                        ...
                        $qtd   = $item['qtd'];
                        $totalItem = number_format($item['preco'] * $item['qtd'], 2, ',', '.');
                        ?>
                        <div class="flex items-center bg-gray-800 p-5 rounded-xl shadow-lg hover:shadow-blue-500/30 transition">
                            ...
                            <div class="ml-4 flex-1">
                                ...
                                <div class="flex items-center gap-2 mt-1">
                                    <span class="text-yellow-400 font-bold">R$ <?= $preco ?></span>
                                ...
                                <div class="flex items-center mt-3">
                                    ...
                                    <input type="text" value="<?= $qtd ?>" class="w-12 text-center border border-gray-600 bg-gray-900">
                                    <button class="bg-gray-700 px-2 py-1 rounded-r hover:bg-blue-500"><i class="fas fa-plus"></i></button>
                                </div>
                            </div>
                            <div class="text-right">
                                <p class="font-bold text-yellow-400">R$ <?= $totalItem ?></p>
                ...
                <div class="bg-gray-800 p-6 rounded-xl shadow-lg border border-blue-500/30">
                    ...
                    <div class="flex justify-between mb-2">
                        <span>Subtotal</span>
                        <span class="text-yellow-400">R$ <?= $subtotalFormatado ?></span>
                    </div>
                    ...
                    <div class="flex justify-between font-bold text-lg">
                        <span>Total</span>
                        <span id="totalCompra" class="text-yellow-400 transition-all duration-300">R$ <?= $subtotalFormatado ?></span>
                    </div>
